                        ...
                        <div class="page-wrapper form-place">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h4 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-pocket text-c-green f-30 m-r-10"></i> 20 project</h4>
                                                </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">supervisor</h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h4 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-users text-c-green f-30 m-r-10"></i> 20 Teachers</h4>
                                                </div>
